<body>
    ...
    <nav>
        <ul class="nav">
            <li><a href="index.php"><img src="assets/img/logo/LOGO_DAIKLES.jpg" alt="LOGO_DAIKLES" height="50px"></a></li>
            <li><a href="homme.php">Homme</a></li>
            <li><a href="homme.php">Femme</a></li>
            <li><a href="homme.php">Sneakers</a></li>
            <li><a href="homme.php">Accessoires</a></li>
            <li><a href="compte.php">Mon compte</a></li>
            <li><a href="panier.php"><svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 100 97.7" style="enable-background:new 0 0 100 97.7;" width=30px height=30px xml:space="preserve">
<g>
